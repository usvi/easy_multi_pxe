...
emp_collect_provisioning_variables()
{
    ...
    EMP_BOOT_OS_ASSETS_HTTP_BASE_PATH="$EMP_WEBSERVER_PROTOCOL://$EMP_WEBSERVER_IP/$EMP_WEBSERVER_ASSETS_PATH_PREFIX/$EMP_BOOT_OS_ASSETS_SUBDIR"
...
emp_process_config_line()
{
	...
	"WEBSERVER_PROTOCOL="*)
	    ...
	    ;;
        "WEBSERVER_ASSETS_PATH_PREFIX="*)
            EMP_WEBSERVER_ASSETS_PATH_PREFIX=${1#"WEBSERVER_ASSETS_PATH_PREFIX="}
	    ;;
        "WEBSERVER_DRIVERS_PATH_PREFIX="*)
            EMP_WEBSERVER_DRIVERS_PATH_PREFIX=${1#"WEBSERVER_DRIVERS_PATH_PREFIX="}
	    ;;
        "DRIVERS_BASE_DIR="*)
...
emp_read_config()
{
    ...
    EMP_WEBSERVER_IP=""
    EMP_WEBSERVER_ASSETS_PATH_PREFIX="netbootassets"
    EMP_WEBSERVER_DRIVERS_PATH_PREFIX="drivers"
...
emp_create_initrd_preseed()
{
    ...
    TEMP_DIRECTORY="/$EMP_WEBSERVER_ASSETS_PATH_PREFIX/$EMP_BOOT_OS_ASSETS_SUBDIR/$EMP_BOOT_OS_ASSETS_UNPACKED_ISO_SUBDIR"
