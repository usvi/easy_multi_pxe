...
sed "s|{EMP_CONFIG_DIR}|$CONFIGS_DIR|g;s|{EMP_WEBSERVER_PREFIX}|$WEBSERVER_PREFIX|g;s|{EMP_SCRIPTS_DIR}|$SCRIPTS_DIR|g;s|{EMP_ASSETS_DIR}|$ASSETS_DIR|g;s|{EMP_TFTPROOT_DIR}|$TFTPROOT_DIR|g;" "$APACHE_EMP_CONF_TEMPLATE" > "$APACHE_EMP_CONF_FINAL"
echo "done."
...
sed "s|{EMP_CONFIG_DIR}|$CONFIGS_DIR|g;s|{EMP_WEBSERVER_PREFIX}|$WEBSERVER_PREFIX|g;s|{EMP_SCRIPTS_DIR}|$SCRIPTS_DIR|g;s|{EMP_ASSETS_DIR}|$ASSETS_DIR|g;s|{EMP_TFTPROOT_DIR}|$TFTPROOT_DIR|g;s|{EMP_PHP_FPM_RUN_SOCK}|$PHP_FPM_RUN_SOCK|g;" "$NGINX_EMP_CONF_TEMPLATE" > "$NGINX_EMP_CONF_FINAL"
echo "done."
